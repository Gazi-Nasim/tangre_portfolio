        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="single-news card">
                    <img class="card-top-img" src="{{asset('front_assets/img/news/n1.jpg')}}" alt="Card image cap">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-news card">
                    <img class="card-top-img" src="{{asset('front_assets/img/news/n2.jpg')}}" alt="Card image cap">
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="#">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-news card">
                    <img class="card-top-img" src="{{asset('front_assets/img/news/n3.jpg')}}" alt="Card image cap">
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="#">
                ...
                <div class="projects_inner row" id="lightgallery">
                    <div class="col-lg-4 col-sm-6 web all" data-src="{{asset('front_assets/img/project/p1.jpg')}}">
                        <div class="projects_item">
                            <img class="img-fluid w-100" src="{{asset('front_assets/img/project/p1.jpg')}}" alt="">
                            <div class="icon">
                    ...
                    <div class="col-lg-4 col-sm-6 brand all creative" data-src="{{asset('front_assets/img/project/p2.jpg')}}">
                        <div class="projects_item">
                            <img class="img-fluid w-100" src="{{asset('front_assets/img/project/p2.jpg')}}" alt="">
                            <div class="icon">
                                <img class="img-fluid" src="{{asset('front_assets/img/icon.png')}}" alt="">
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 all" data-src="{{asset('front_assets/img/project/p3.jpg')}}">
                        <div class="projects_item">
                            <img class="img-fluid w-100" src="{{asset('front_assets/img/project/p3.jpg')}}" alt="">
                            <div class="icon">
                                <img class="img-fluid" src="{{asset('front_assets/img/icon.png')}}" alt="">
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 all print-mat" data-src="{{asset('front_assets/img/project/p4.jpg')}}">
                        <div class="projects_item">
                            <img class="img-fluid w-100" src="{{asset('front_assets/img/project/p4.jpg')}}" alt="">
                            <div class="icon">
                                <img class="img-fluid" src="{{asset('front_assets/img/icon.png')}}" alt="">
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 brand img-man all" data-src="{{asset('front_assets/img/project/p5.jpg')}}">
                        <div class="projects_item">
                            <img class="img-fluid w-100" src="{{asset('front_assets/img/project/p5.jpg')}}" alt="">
                            <div class="icon">
                                <img class="img-fluid" src="{{asset('front_assets/img/icon.png')}}" alt="">
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 brand work img-man all" data-src="{{asset('front_assets/img/project/p6.jpg')}}">
                        <div class="projects_item">
                            <img class="img-fluid w-100" src="{{asset('front_assets/img/project/p6.jpg')}}" alt="">
                            <div class="icon">
                                <img class="img-fluid" src="{{asset('front_assets/img/icon.png')}}" alt="">
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="active-testimonial-carusel">
                <div class="single-testimonial item d-flex flex-row">
                    <div class="thumb">
                        <img class="img-fluid" src="{{asset('front_assets/img/elements/user1.png')}}" alt="">
                    </div>
                    <div class="desc">
                        <p>
                ...
                <div class="single-testimonial item d-flex flex-row">
                    <div class="thumb">
                        <img class="img-fluid" src="{{asset('front_assets/img/elements/user2.png')}}" alt="">
                    </div>
                    <div class="desc">
                        <p>
                            Accessories Here you can find the best computer accessory for your laptop, monitor, printer, scanner, speaker, projector,
