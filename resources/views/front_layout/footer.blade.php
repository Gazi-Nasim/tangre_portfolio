    ...
    <div class="container" style="background-color: #8c908316; height: 450px; padding:50px;">
        <div class="justify-content-center">
            ...
            <div class="row">
                ...
                <!-- Right Section -->
                <div class="col-5 text-end footer-content" style="text-align: right ;">
                    <h4>FOLLOW US ON SOCIAL NETWORK</h4>
                    <div class="social-icons social_icons_section" style="">

                        <a style="" href="https://www.facebook.com/share/1EudBRVVXr/?mibextid=LQQJ4d"
                            aria-label="Facebook">
                            <i style="color: gray;" class="fa fa-facebook-square fa-2x"></i>
                        </a>
                        <a href="#" aria-label="whatsapp">
                            <i style="color: gray;" class="fa fa-whatsapp fa-2x text-green" aria-hidden="true"></i>
                        </a>
                        <a href="#" aria-label="Instagram">
                            <i style="color: gray;" class="fa fa-instagram fa-2x"></i>
                        </a>
                        <a href="#" aria-label="Instagram">
