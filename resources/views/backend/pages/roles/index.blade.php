                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="float-right mb-2">
                            ...
                            <a class="btn btn-primary text-white" href="{{ route('role.create') }}">Create New Role</a>
                            @endif
                        </p>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if (Auth::guard('web')->user()->can('role.edit'))
                                            <a class="btn btn-danger text-white" href="{{ route('role.destroy', $role->id) }}" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $role->id }}').submit();">
                                                Delete
                                            </a>
