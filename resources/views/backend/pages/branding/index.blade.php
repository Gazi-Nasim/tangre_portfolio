    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Add Branding Information </h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            @if (isset($edit))
                                <form action="{{ route('branding.update', $edit->id) }}" method="post" class="row"
                                    enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                @else
                                    <form action="{{ route('branding.store') }}" method="post" class="row"
                                        enctype="multipart/form-data">
                                        @csrf
                            @endif
                            ...
                            <div class="form-group col-6">
                                <label for="photo">Branding Photo</label>
