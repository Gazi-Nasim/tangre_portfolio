      ...
      <div class="col-12">
        <div class="card card-primary card-outline">
          ...
          <div class="card-body">
            ...
            @if(isset($edit))
            <form action="{{route('offer.update', $edit->id)}}" method="post" class="row" enctype="multipart/form-data">
              @method('PUT')
              @csrf
              @else
              <form action="{{route('offer.store')}}" method="post" class="row" enctype="multipart/form-data">
                @csrf
                @endif
